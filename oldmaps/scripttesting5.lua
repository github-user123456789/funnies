...
script.Parent.Parent.Touched:connect(onTouch) 
                ...
                },
                {
                    ...
                    Reflectance = 0,
                    Color = Color3.new(0.768627, 0.156863, 0.109804),
                    CFrame = CFrame.new(-69.5659866, 6.60014915, 43.2859917, -1.81898832e-12, -5.57611006e-11, 0.999998808, 6.18456258e-11, 1, -5.57611006e-11, -0.999998808, -6.18456258e-11, 1.81898832e-12),
                    RightSurface = [==[Smooth]==],
                    RotVelocity = Vector3.new(0, 0, 0),
                    FrontSurface = [==[Smooth]==],
                    Material = [==[Plastic]==],
